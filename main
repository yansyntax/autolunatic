...
(apt install nodejs -y >/dev/null 2>&1 && apt install npm -y >/dev/null 2>&1 && npm install -g pm2 >/dev/null 2>&1) & loading $! "Installing Node.js LTS + pm2"
...
(apt install cron -y >/dev/null 2>&1) & loading $! "Installing cronJOB"
...
apt install zip -y >/dev/null 2>&1 & loading $! "Installing zip"
apt install pwgen -y >/dev/null 2>&1 & loading $! "Installing pwgen"
apt install openssl -y >/dev/null 2>&1 & loading $! "Installing openssl"
apt install bash-completion -y >/dev/null 2>&1 & loading $! "Installing bash-completion"
apt install sudo -y >/dev/null 2>&1 & loading $! "Installing sudo"

apt install unzip -y >/dev/null 2>&1 & loading $! "Installing unzip"
apt install p7zip-full -y >/dev/null 2>&1 & loading $! "Installing p7zip"
apt install screen -y >/dev/null 2>&1 & loading $! "Installing screen"
apt install cmake -y >/dev/null 2>&1 & loading $! "Installing cmake"
apt install make -y >/dev/null 2>&1 & loading $! "Installing make"
apt install build-essential -y >/dev/null 2>&1 & loading $! "Installing build-essential"

apt install gnupg -y >/dev/null 2>&1 & loading $! "Installing gnupg"
apt install gnupg2 -y >/dev/null 2>&1 & loading $! "Installing gnupg2"
apt install gnupg1 -y >/dev/null 2>&1 & loading $! "Installing gnupg1"
apt install apt-transport-https -y >/dev/null 2>&1 & loading $! "Installing apt-transport-https"
apt install lsb-release -y >/dev/null 2>&1 & loading $! "Installing lsb-release"
apt install jq -y >/dev/null 2>&1 & loading $! "Installing jq"

apt install htop -y >/dev/null 2>&1 & loading $! "Installing htop"
apt install lsof -y >/dev/null 2>&1 & loading $! "Installing lsof"
apt install tar -y >/dev/null 2>&1 & loading $! "Installing tar"
apt install dnsutils -y >/dev/null 2>&1 & loading $! "Installing dnsutils"

apt install python3-pip -y >/dev/null 2>&1 & loading $! "Installing pip"
apt install python-is-python3 -y >/dev/null 2>&1 & loading $! "Installing python alias"

apt install ca-certificates -y >/dev/null 2>&1 & loading $! "Installing ca-certificates"
apt install bsd-mailx -y >/dev/null 2>&1 & loading $! "Installing mailx"
apt install msmtp-mta -y >/dev/null 2>&1 & loading $! "Installing msmtp"

apt install ntpdate -y >/dev/null 2>&1 & loading $! "Installing ntpdate"
apt install chrony -y >/dev/null 2>&1 & loading $! "Installing chrony"
apt install easy-rsa -y >/dev/null 2>&1 & loading $! "Installing easy-rsa"
apt install openvpn -y >/dev/null 2>&1 & loading $! "Installing openvpn"

apt install net-tools -y >/dev/null 2>&1 & loading $! "Installing net-tools"
apt install rsyslog -y >/dev/null 2>&1 & loading $! "Installing rsyslog"
apt install sed -y >/dev/null 2>&1 & loading $! "Installing sed"
apt install xz-utils -y >/dev/null 2>&1 & loading $! "Installing xz-utils"
apt install libc6 -y >/dev/null 2>&1 & loading $! "Installing libc6"
apt install util-linux -y >/dev/null 2>&1 & loading $! "Installing util-linux"

apt install shc -y >/dev/null 2>&1 & loading $! "Installing shc"
apt install gcc -y >/dev/null 2>&1 & loading $! "Installing gcc"
apt install g++ -y >/dev/null 2>&1 & loading $! "Installing g++"

apt install libnss3-dev -y >/dev/null 2>&1 & loading $! "Installing libnss3-dev"
apt install libnspr4-dev -y >/dev/null 2>&1 & loading $! "Installing libnspr4-dev"
apt install pkg-config -y >/dev/null 2>&1 & loading $! "Installing pkg-config"
apt install libpam0g-dev -y >/dev/null 2>&1 & loading $! "Installing libpam"
apt install libcap-ng-dev -y >/dev/null 2>&1 & loading $! "Installing libcap-ng-dev"
apt install libcap-ng-utils -y >/dev/null 2>&1 & loading $! "Installing libcap-ng-utils"
apt install libselinux1-dev -y >/dev/null 2>&1 & loading $! "Installing libselinux"

apt install libcurl4-nss-dev -y >/dev/null 2>&1 & loading $! "Installing libcurl"
apt install flex -y >/dev/null 2>&1 & loading $! "Installing flex"
apt install bison -y >/dev/null 2>&1 & loading $! "Installing bison"

apt install libnss3-tools -y >/dev/null 2>&1 & loading $! "Installing libnss3-tools"
apt install libevent-dev -y >/dev/null 2>&1 & loading $! "Installing libevent"
apt install zlib1g-dev -y >/dev/null 2>&1 & loading $! "Installing zlib"
apt install libssl-dev -y >/dev/null 2>&1 & loading $! "Installing ssl-dev"
apt install libsqlite3-dev -y >/dev/null 2>&1 & loading $! "Installing sqlite3-dev"

apt install libxml-parser-perl -y >/dev/null 2>&1 & loading $! "Installing xml-parser"
apt install dirmngr -y >/dev/null 2>&1 & loading $! "Installing dirmngr"
...
FOLDER_SETUP() {
    ...
    for s in "${services[@]}"; do
        ...
        mkdir -p "$base/ip"
        mkdir -p "$base/detail"
        mkdir -p "$base/quota/usage"
        mkdir -p "$base/quota/used"
        mkdir -p "$base/quota/today"
        mkdir -p "$base/quota/last"
    done

    # =========================
    # TRIALL (JSON BASED)
    # =========================
    TRIAL="/etc/lunatic/triall"
    mkdir -p "$TRIAL"
    ...
    # =========================
    # TELEGRAM CONFIG (UNIFIED)
    # =========================
    TELE="/etc/lunatic/telegram.json"
