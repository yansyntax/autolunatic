...
LINE="${CYAN_DIM}────────────────────────────────────────────────${NC}"
LINE_THIN="${DIM}┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄${NC}"
GIT_REPO="https://raw.githubusercontent.com/yansyntax/autolunatic/main/"
# ══════════════════════════════════════════════
#              SPINNER LOADING
# ══════════════════════════════════════════════
loading() {
...
(curl -s https://raw.githubusercontent.com/acmesh-official/acme.sh/master/acme.sh -o /root/.acme.sh/acme.sh) & loading $! "Downloading acme.sh"
...
PROXY_SETUP() {
    ...
    if [[ "$OS_ID" == "ubuntu" ]]; then
        ...
        # Pastikan haproxy & nginx binary tersedia, retry jika gagal
        if ! command -v haproxy >/dev/null 2>&1; then
            print_info "HAProxy not found, retrying install..."
            apt-get install haproxy -y >/dev/null 2>&1 || { print_error "HAProxy install failed!"; exit 1; }
        fi
        if ! command -v nginx >/dev/null 2>&1; then
            print_info "Nginx not found, retrying install..."
            apt-get install nginx -y >/dev/null 2>&1 || { print_error "Nginx install failed!"; exit 1; }
        fi
        ...
        if ! command -v haproxy >/dev/null 2>&1; then
            print_info "HAProxy not found, retrying install..."
            apt install haproxy -y >/dev/null 2>&1 || { print_error "HAProxy install failed!"; exit 1; }
        fi
        if ! command -v nginx >/dev/null 2>&1; then
            print_info "Nginx not found, retrying install..."
            apt install nginx -y >/dev/null 2>&1 || { print_error "Nginx install failed!"; exit 1; }
        fi
        mkdir -p /etc/haproxy /etc/nginx/conf.d /etc/nginx/sites-available /etc/nginx/sites-enabled
        systemctl stop haproxy >/dev/null 2>&1
        systemctl stop nginx >/dev/null 2>&1
...
apt install -y zip >/dev/null 2>&1 & loading $! "Installing zip"
apt install -y pwgen >/dev/null 2>&1 & loading $! "Installing pwgen"
apt install -y openssl >/dev/null 2>&1 & loading $! "Installing openssl"
apt install -y cron >/dev/null 2>&1 & loading $! "Installing cron"
apt install -y bash-completion >/dev/null 2>&1 & loading $! "Installing bash-completion"
apt install -y sudo >/dev/null 2>&1 & loading $! "Installing sudo"

apt install -y unzip >/dev/null 2>&1 & loading $! "Installing unzip"
apt install -y p7zip-full >/dev/null 2>&1 & loading $! "Installing p7zip"
apt install -y screen >/dev/null 2>&1 & loading $! "Installing screen"
apt install -y cmake >/dev/null 2>&1 & loading $! "Installing cmake"
apt install -y make >/dev/null 2>&1 & loading $! "Installing make"
apt install -y build-essential >/dev/null 2>&1 & loading $! "Installing build-essential"

apt install -y gnupg >/dev/null 2>&1 & loading $! "Installing gnupg"
apt install -y gnupg2 >/dev/null 2>&1 & loading $! "Installing gnupg2"
apt install -y gnupg1 >/dev/null 2>&1 & loading $! "Installing gnupg1"
apt install -y apt-transport-https >/dev/null 2>&1 & loading $! "Installing apt-transport-https"
apt install -y lsb-release >/dev/null 2>&1 & loading $! "Installing lsb-release"
apt install -y jq >/dev/null 2>&1 & loading $! "Installing jq"

apt install -y htop >/dev/null 2>&1 & loading $! "Installing htop"
apt install -y lsof >/dev/null 2>&1 & loading $! "Installing lsof"
apt install -y tar >/dev/null 2>&1 & loading $! "Installing tar"
apt install -y dnsutils >/dev/null 2>&1 & loading $! "Installing dnsutils"

apt install -y python3-pip >/dev/null 2>&1 & loading $! "Installing pip"
apt install -y python-is-python3 >/dev/null 2>&1 & loading $! "Installing python alias"

apt install -y ca-certificates >/dev/null 2>&1 & loading $! "Installing ca-certificates"
apt install -y bsd-mailx >/dev/null 2>&1 & loading $! "Installing mailx"
apt install -y msmtp-mta >/dev/null 2>&1 & loading $! "Installing msmtp"

apt install -y ntpdate >/dev/null 2>&1 & loading $! "Installing ntpdate"
apt install -y chrony >/dev/null 2>&1 & loading $! "Installing chrony"
apt install -y easy-rsa >/dev/null 2>&1 & loading $! "Installing easy-rsa"
apt install -y openvpn >/dev/null 2>&1 & loading $! "Installing openvpn"

apt install -y net-tools >/dev/null 2>&1 & loading $! "Installing net-tools"
apt install -y rsyslog >/dev/null 2>&1 & loading $! "Installing rsyslog"
apt install -y sed >/dev/null 2>&1 & loading $! "Installing sed"
apt install -y xz-utils >/dev/null 2>&1 & loading $! "Installing xz-utils"
apt install -y libc6 >/dev/null 2>&1 & loading $! "Installing libc6"
apt install -y util-linux >/dev/null 2>&1 & loading $! "Installing util-linux"

apt install -y shc >/dev/null 2>&1 & loading $! "Installing shc"
apt install -y gcc >/dev/null 2>&1 & loading $! "Installing gcc"
apt install -y g++ >/dev/null 2>&1 & loading $! "Installing g++"

apt install -y libnss3-dev >/dev/null 2>&1 & loading $! "Installing libnss3-dev"
apt install -y libnspr4-dev >/dev/null 2>&1 & loading $! "Installing libnspr4-dev"
apt install -y pkg-config >/dev/null 2>&1 & loading $! "Installing pkg-config"
apt install -y libpam0g-dev >/dev/null 2>&1 & loading $! "Installing libpam"
apt install -y libcap-ng-dev >/dev/null 2>&1 & loading $! "Installing libcap-ng-dev"
apt install -y libcap-ng-utils >/dev/null 2>&1 & loading $! "Installing libcap-ng-utils"
apt install -y libselinux1-dev >/dev/null 2>&1 & loading $! "Installing libselinux"

apt install -y libcurl4-nss-dev >/dev/null 2>&1 & loading $! "Installing libcurl"
apt install -y flex >/dev/null 2>&1 & loading $! "Installing flex"
apt install -y bison >/dev/null 2>&1 & loading $! "Installing bison"

apt install -y libnss3-tools >/dev/null 2>&1 & loading $! "Installing libnss3-tools"
apt install -y libevent-dev >/dev/null 2>&1 & loading $! "Installing libevent"
apt install -y zlib1g-dev >/dev/null 2>&1 & loading $! "Installing zlib"
apt install -y libssl-dev >/dev/null 2>&1 & loading $! "Installing ssl-dev"
apt install -y libsqlite3-dev >/dev/null 2>&1 & loading $! "Installing sqlite3-dev"

apt install -y libxml-parser-perl >/dev/null 2>&1 & loading $! "Installing xml-parser"
apt install -y dirmngr >/dev/null 2>&1 & loading $! "Installing dirmngr"
...
FOLDER_SETUP() {
    ...
    local lunatic_services=(
        "vmess" "vless" "trojan" "ssh" "bot" "zivpn" "triall" "monitor/notif"
    )
    ...
    # =========================
    for service in "${lunatic_services[@]}"; do
        base="/etc/lunatic/$service"

        mkdir -p "$base"/{usage,ip,detail}
        mkdir -p "$base/quota"/{used,today,last,usage}
    done
    ...
    # GLOBAL DB
    # =========================
    touch /etc/lunatic/{ssh,vmess,vless,trojan}.db
...
XRAY_SETUP() {
    ...
    (wget -q -O /etc/xray/config.json "${GIT_REPO}configure/config.json") & loading $! "Downloading Xray config"
    (wget -q -O /etc/systemd/system/runn.service "${GIT_REPO}configure/runn.service") & loading $! "Downloading runn.service"
    ...
    # Pastikan semua direktori config ada sebelum download
    mkdir -p /etc/haproxy /etc/nginx/conf.d /etc/nginx/sites-available /etc/nginx/sites-enabled /usr/local/share/xray
    (wget -q -O /etc/haproxy/haproxy.cfg "${GIT_REPO}configure/haproxy.cfg") & loading $! "Downloading haproxy.cfg"
    (wget -q -O /etc/nginx/conf.d/xray.conf "${GIT_REPO}configure/xray.conf") & loading $! "Downloading xray.conf"
    (curl -s "${GIT_REPO}configure/nginx.conf" > /etc/nginx/nginx.conf) & loading $! "Downloading nginx.conf"

    sed -i "s/xxx/${domain}/g" /etc/haproxy/haproxy.cfg
    sed -i "s/xxx/${domain}/g" /etc/nginx/conf.d/xray.conf

    # Pastikan cert ada sebelum buat hap.pem (SSL mungkin belum di-issue saat ini)
    if [[ -f /etc/xray/xray.crt && -f /etc/xray/xray.key ]]; then
        cat /etc/xray/xray.crt /etc/xray/xray.key > /etc/haproxy/hap.pem
    else
        print_info "SSL cert not yet issued — hap.pem will be created after SSL setup"
    fi
...
EOF
    ...
    # Buat hap.pem dari SSL cert yang sudah di-install
      if [[ -f /etc/xray/xray.crt && -f /etc/xray/xray.key ]]; then
          cat /etc/xray/xray.crt /etc/xray/xray.key > /etc/haproxy/hap.pem
          chmod 600 /etc/haproxy/hap.pem
          print_ok "HAProxy PEM certificate created"
      fi
...
PW_DEFAULT() {
    ...
    local password_url="https://raw.githubusercontent.com/yansyntax/autolunatic/main/configure/password"
...
LIMIT_HANDLER() {
    ...
    (wget -q https://raw.githubusercontent.com/yansyntax/autolunatic/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh >/dev/null 2>&1) & loading $! "Installing LimitHandler"

    mkdir -p /usr/local/lunatic
    (wget -q -O /usr/local/lunatic/udp-mini "${GIT_REPO}configure/udp-mini") & loading $! "Downloading udp-mini binary"
    chmod +x /usr/local/lunatic/udp-mini

    for i in 1 2 3; do
        (wget -q -O /etc/systemd/system/udp-mini-$i.service "${GIT_REPO}configure/udp-mini-$i.service") & loading $! "Downloading udp-mini-$i service"
...
SSHD_SETUP(){
    ...
    (wget -q -O /etc/ssh/sshd_config "${GIT_REPO}configure/sshd" >/dev/null 2>&1) & loading $! "Downloading SSHD config"
...
#    (wget -q ${GIT_REPO}dropbear19.sh && chmod +x dropbear19.sh && ./dropbear19.sh >/dev/null 2>&1) & loading $! "Running Dropbear 2019 installer"
    ...
    (wget -qO- https://raw.githubusercontent.com/yansyntax/autolunatic/main/dropbear19.sh | sed 's/\r$//' | bash >/dev/null 2>&1) & loading $! "Running Dropbear 2019 installer"  
...
OPVPN_SETUP() {
    ...
    (wget -q ${GIT_REPO}configure/openvpn && chmod +x openvpn && ./openvpn >/dev/null 2>&1) & loading $! "Installing OpenVPN"
...
EOF
    ...
    (wget -q -O /etc/ipserver "${GIT_REPO}configure/ipserver" && bash /etc/ipserver >/dev/null 2>&1) & loading $! "Downloading & running ipserver"
...
SWAPRAM_SETUP(){
    ...
    (wget -q ${GIT_REPO}configure/bbr.sh && chmod +x bbr.sh && ./bbr.sh >/dev/null 2>&1) & loading $! "Installing TCP BBR"
...
FAIL2BAN_SETUP(){
    ...
    (wget -q -O /etc/banner.txt "${GIT_REPO}banner/issue.net") & loading $! "Downloading SSH banner"
...
WEBSOCKET_SETUP() {
    ...
    (wget -q -O "$ws_bin" "${GIT_REPO}configure/ws") & loading $! "Downloading ws binary"
    sleep 1
    (wget -q -O "$tun_conf" "${GIT_REPO}configure/tun.conf") & loading $! "Downloading tun.conf"
    sleep 1
    (wget -q -O "$ws_service" "${GIT_REPO}configure/ws.service") & loading $! "Downloading ws.service"
    sleep 1
    mkdir -p "$(dirname "$rclone_root")"
      (wget -q -O "$rclone_root" "${GIT_REPO}configure/rclone.conf") & loading $! "Downloading rclone.conf"
    sleep 1    
    (wget -q -O "$ltvpn_bin" "${GIT_REPO}configure/ltvpn") & loading $! "Downloading LTVPN"
    
    (wget -q ${GIT_REPO}configure/dirmeluna.sh && chmod +x dirmeluna.sh && ./dirmeluna.sh >/dev/null 2>&1) & loading $! "Setting up ws.py connection"
...
#    (wget -q -O "$ltvpn_bin" "${GIT_REPO}configure/ltvpn") & loading $! "Downloading ltvpn binary"
#    chmod +x "$ltvpn_bin"
...
(wget -q https://raw.githubusercontent.com/yansyntax/autolunatic/main/feature/LUNAVPN >/dev/null 2>&1) & loading $! "Downloading LUNAVPN feature package"
...
function RESTART_SERVICE() {
    clear
    print_install "Restarting & Enabling All Services"
...
clear
curl -fsSL -o backend.sh https://raw.githubusercontent.com/yansyntax/autolunatic/main/configure/backend.sh
bash backend.sh
}
...
function UDEPE() {
clear
curl -fsSL -o install.sh https://raw.githubusercontent.com/yansyntax/autolunatic/main/udp/install.sh
bash install.sh
}
